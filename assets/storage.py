...
LEAGUE_TABLE_DATA01 = pd.read_csv('db/league_table_data/league_1.csv', index_col=0)
LEAGUE_TABLE_DATA02 = pd.read_csv('db/league_table_data/league_2.csv', index_col=0)

LEAGUE_TABLE_DATA1 = pd.read_csv('db/league_table_data/league_table.csv', index_col=0)
LEAGUE_TABLE_DATA2 = pd.read_csv('db/league_table_data/league_table2.csv', index_col=0)
...
# league_table_data_STORAGE=[[LEAGUE_TABLE_DATA01,LEAGUE_TABLE_DATA1],[LEAGUE_TABLE_DATA2,LEAGUE_TABLE_DATA02]]
# league_table_data_STORAGE = [
#     [LEAGUE_TABLE_DATA01.to_json(orient='split'), LEAGUE_TABLE_DATA1.to_json(orient='split')],
#     [LEAGUE_TABLE_DATA2.to_json(orient='split'), LEAGUE_TABLE_DATA02.to_json(orient='split')]
# ]
# league_table_data_STORAGE_serialized = json.dumps(league_table_data_STORAGE)

# print("Type of data_STORAGE_serialized:",type(league_table_data_STORAGE_serialized))
...
DEFAULT_DATA = OrderedDict(raw_data_STORAGE = [RAW_DATA],
                        ...
                        #    league_table_data_STORAGE=[LEAGUE_TABLE_DATA2],
                           league_table_data_STORAGE=[LEAGUE_TABLE_DATA01,LEAGUE_TABLE_DATA1,LEAGUE_TABLE_DATA2,LEAGUE_TABLE_DATA02],
                           # league_table_data_STORAGE=[LEAGUE_TABLE_DATA01,LEAGUE_TABLE_DATA1],
...
# print("Serialized Test Data:", league_table_data_STORAGE_serialized)

# Simulate callback
# deserialized_data = json.loads(league_table_data_STORAGE_serialized)
# # print("Deserialized Test Data:", deserialized_data)
# print("Type of test_data:", type(deserialized_data))

# print(deserialized_data[0][0])
