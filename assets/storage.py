...
LEAGUE_TABLE_DATA_BOTH = pd.read_csv('db/league_table_data/league_table.csv', index_col=0)
...
DEFAULT_DATA = OrderedDict(
                        ...
                        #    league_table_data_STORAGE=[LEAGUE_TABLE_DATA2],
                           league_table_data_STORAGE=[LEAGUE_TABLE_DATA1,LEAGUE_TABLE_DATA2, LEAGUE_TABLE_DATA_BOTH],
                        ...
                        #    net_split_ALL_data_out2_STORAGE=NETSPLIT_DATA_ALL_OUT2,
                           ...
                           cinema_net_data_STORAGE2=[CINEMA_NET_DATA1,CINEMA_NET_DATA2],
                           )
